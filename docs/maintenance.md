...
> Current maintenance focus (2026-09-15): keep CSV output deterministic and spreadsheet-safe while applying URL canonicalization conservatively—normalize only clearly equivalent URL forms and preserve unknown path or query semantics.
